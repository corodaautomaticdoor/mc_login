...
public class Constants {
    ...
    public final static String VALIDATE_ACCOUNT = "/validate_login";
    ...
    public final static String VALIDATE_VALUE="Metodo a traves del cual se validan los datos del usuario";
    public final static String VALIDATE_NOTE="Para la obtencion de datos del Login  es necesario enviar el correo y la constraseña ";
